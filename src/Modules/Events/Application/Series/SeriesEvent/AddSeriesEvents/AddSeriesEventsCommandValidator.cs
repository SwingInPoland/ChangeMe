...
internal class AddSeriesEventsCommandValidator : AbstractValidator<AddSeriesEventsCommand>
{
    public AddSeriesEventsCommandValidator()
    {
        ...
        RuleForEach(x => x.Dates)
            ...
            .Must(x => x.EndDate > x.StartDate).WithMessage("End date must be greater than start date.");
