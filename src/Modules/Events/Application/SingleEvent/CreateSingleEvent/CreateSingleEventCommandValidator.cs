...
internal class CreateSingleEventCommandValidator : AbstractValidator<CreateSingleEventCommand>
{
    public CreateSingleEventCommandValidator()
    {
        RuleFor(x => x.Names)
        ...
        RuleFor(x => x.Status)
            ...
            .MaximumLength(1000).WithMessage("Status must not be longer than 1000 characters.");
