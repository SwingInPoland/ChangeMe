...
internal class ChangeSingleEventMainAttributesCommandHandler : ICommandHandler<ChangeSingleEventMainAttributesCommand>
{
    private readonly ISingleEventRepository _singleEventRepository;
    private readonly IExecutionContextAccessor _executionContextAccessor;

    public ChangeSingleEventMainAttributesCommandHandler(
    ...
    public async Task<Unit> Handle(ChangeSingleEventMainAttributesCommand request, CancellationToken cancellationToken)
    {
        ...
        singleEvent.ChangeMainAttributes(
