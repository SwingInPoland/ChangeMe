using ChangeMe.Modules.Events.Domain.Series.ValueObjects.SeriesEventDate.Rules;
using ChangeMe.Modules.Events.Domain.ValueObjects.EventDateBase;

namespace ChangeMe.Modules.Events.Domain.Series.ValueObjects.SeriesEventDate;
