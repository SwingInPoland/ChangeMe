...
using ChangeMe.Modules.Events.Infrastructure.Configuration.Processing.Inbox;
...
//TODO: Background Worker instead of Quartz
internal static class QuartzStartup
{
    ...
    internal static void Initialize(ILogger logger, long? internalProcessingPoolingInterval)
    {
        ...
        var schedulerConfiguration = new NameValueCollection { { "quartz.scheduler.instanceName", "Meetings" } };
    ...
    internal static void StopQuartz() => _scheduler?.Shutdown();
}